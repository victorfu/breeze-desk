...
Item {
    ...
    function localComputeSummary(selectedBackend, actualBackend) {
        const selected = UiText.computeBackendName(selectedBackend)
        ...
        ColumnLayout {
            ...
            InspectorSection {
                ...
                SettingRow {
                    ...
                    Toggle {
                        accessibleName: qsTr("Launch at startup")
                        checked: root.vm.launchAtStartup
                        onToggled: root.vm.launchAtStartup = checked
                    }
                }
                SettingRow {
            ...
            InspectorSection {
                ...
                SettingRow {
                    ...
                    Toggle {
                        accessibleName: qsTr("Compact mode")
                        checked: root.vm.compactMode
                        onToggled: root.vm.compactMode = checked
                    }
                }
                SettingRow {
                    ...
                    AppComboBox {
                        Layout.fillWidth: true
                        accessibleName: qsTr("Waveform density")
            ...
            InspectorSection {
                ...
                SettingRow {
                    ...
                    AppComboBox {
                        Layout.fillWidth: true
                        accessibleName: qsTr("Default model")
                ...
                SettingRow {
                    ...
                    AppComboBox {
                        ...
                        model: [qsTr("Chinese (zh)"), qsTr("Automatic")]
                        currentIndex: root.vm.transcriptionLanguage === "zh" ? 0 : 1
                        onActivated: root.vm.transcriptionLanguage = currentIndex === 0 ? "zh" : "auto"
                    }
                }
                SettingRow {
                    label: qsTr("Preset")
                ...
                SettingRow {
                    ...
                    Toggle {
                        accessibleName: qsTr("Silero VAD")
                        checked: root.vm.vadEnabled
                        onToggled: root.vm.vadEnabled = checked
                    }
                }
                SettingRow {
                ...
                SettingRow {
                    ...
                    Toggle {
                        ...
                        checked: root.vm.flashAttention
                        onToggled: root.vm.flashAttention = checked
                    }
                }
                SettingRow {
                    ...
                    Toggle {
                        ...
                        checked: root.vm.tokenTimestamps
                        onToggled: root.vm.tokenTimestamps = checked
                    }
                }
                SettingRow {
                    ...
                    AppSpinBox {
                        ...
                        from: 1
                        to: 64
                        value: root.vm.threadCount
                        editable: true
                        accessibleName: qsTr("Worker threads")
                        onValueModified: root.vm.threadCount = value
                    }
                }
                SettingRow {
            ...
            InspectorSection {
                ...
                SettingRow {
                    ...
                    AppComboBox {
                        Layout.fillWidth: true
                        accessibleName: qsTr("Managed media")
                        model: [qsTr("Reference original"), qsTr("Copy managed media")]
                        currentIndex: root.vm.managedMediaPolicy === "ReferenceOriginal" ? 0 : 1
                        onActivated: root.vm.managedMediaPolicy = currentIndex === 0 ? "ReferenceOriginal" : "CopyManaged"
                    }
                }
            ...
            InspectorSection {
                ...
                title: qsTr("Updates")
                SettingRow {
                    label: qsTr("Automatic update checks")
                    description: qsTr("Disabled by default. No update check runs during startup.")
                    Toggle {
                        accessibleName: qsTr("Automatic update checks")
                        checked: root.vm.automaticUpdates
                        onToggled: root.vm.automaticUpdates = checked
                    }
                }
                SettingRow {
