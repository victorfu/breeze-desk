...
class SqliteJobRepository final : public IJobRepository {
  public:
    ...
    [[nodiscard]] Result<JobEvent> appendEvent(JobEvent event,
    ...
    [[nodiscard]] Result<void> updateParameters(const QString& id,
                                                ...
                                                const QString& ownerToken) override;
    [[nodiscard]] Result<void> replaceChunks(const QString& jobId, const QList<JobChunk>& chunks,
                                             const QString& ownerToken = {}) override;
    [[nodiscard]] Result<QList<JobChunk>> chunks(const QString& jobId) const override;
    [[nodiscard]] Result<void> updateChunk(const JobChunk& chunk,
                                           const QString& ownerToken) override;
    ...
    [[nodiscard]] Result<void> deleteTerminalJob(const QString& id) override;
