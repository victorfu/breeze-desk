...
copies the exact upstream Sparkle or WinSparkle license files and the FFmpeg source/build configuration
beside each binary distribution. `Qt-LGPL-NOTICE.md`, the complete LGPL/GPL terms, and a generated
